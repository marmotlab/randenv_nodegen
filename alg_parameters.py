...
class EnvParameters:
    N_AGENTS = 4  # number of agents used in training todo 8
    N_ACTIONS = 5
    EPISODE_LEN = 512  # maximum episode length in training
    FOV_SIZE = 9
    WORLD_SIZE = (10, 11)   # todo: (10, 40)
...
class TrainingParameters:
    ...
    BLOCK_COEF = 0.5
    N_EPOCHS = 10
    N_ENVS = 1   # number of processes  todo 32
    ...
    DEMONSTRATION_PROB = 0.0  # imitation learning rate  todo: 0.1
...
class RecordingParameters:
    ...
    EXPERIMENT_PROJECT = 'Node_placer'
    EXPERIMENT_NAME = 'prototype2.5'
    EXPERIMENT_NOTE = 'from scratch, fixed raycasting bug'
